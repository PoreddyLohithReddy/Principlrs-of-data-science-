In the data file, the data (Student Performance.csv) is already a clean data so no need to clean it further. 
...
Parental Level of Education -> provides details of the student’s parental education.
